...
Wenn Sie einen Block auswählen, wird dieser markiert und in den Vordergrund gehoben. Zusätzlich werden am linken Rand des Blockes die [*Block-Aktionen*](../../smartstore-page-builder/blocke.md) angezeigt. Das Zahnrad-Icon öffnet den Bearbeitungsmodus des Blockes, mit dem Inhalte und Effekte konfiguriert werden.

Auch im [*Block-Manager*](../benutzeroberflache/block-manager.md) wird der aktuell ausgewählte Block markiert.
