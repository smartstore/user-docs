...
Wenn Sie Text auf einem Bild darstellen wollen, dann nutzen Sie am besten ausschließlich den [*Text-Block*](../../smartstore-page-builder/blocke.md) und fügen das Bild als [*Hintergrund*](../../smartstore-page-builder/blocke/block-basiseinstellungen.md#hintergrund) ein.
