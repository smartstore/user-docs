...
| **Gültigkeit** | Die Gültigkeit eines Rabatts ermöglicht Ihnen, eine Grenze für die Anwendung des Rabatts festzulegen. Sie können angeben, wie oft ein Gutscheincode durch Ihre Kunden benutzt werden kann, entweder global oder spezifisch (z.B. pro Kunde). Sie können auch eine unbegrenzte Nutzung der Gutscheine erlauben.<br><br>- **Unbegrenzt**: Unbegrenzte Nutzung eines Gutscheincodes<br>- **Nur N mal**: Der Gutscheincode darf nur **N** mal angewendet werden.<br>- **N mal pro Benutzer:** Der Gutscheincode darf nur **N mal** pro Kunde angewendet werden. |
