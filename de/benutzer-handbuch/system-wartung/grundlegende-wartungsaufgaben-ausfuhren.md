...
Den Wartungsbereich öffnen Sie über **System > Wartung**. In diesem Bereich können Sie die Performance Ihres Shops optimieren, indem Sie den Bildcache bereinigen, Gastbenutzer löschen oder alte exportierte Dateien löschen. Sie können auch SQL-Abfragen direkt gegen die Datenbank ausführen.
