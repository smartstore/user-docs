...
{% hint style="info" %}
**Preis** und **Hersteller** bzw. **Marke** sind _implizite_ Atttribute und werden immer ganz oben im Filter Widget angezeigt. Sie müssen keine Attribute für diese Eigenschaften angeben! Die verfügbaren Kriterien für **Preis** können in der **Warengruppenkonfiguration** bearbeitet werden **> Allgemein > Preisfilter**.
{% endhint %}
