...
Die Pixlr Funktionalität ist ab Smartstore v6 im [Medien-Manager integriert](mediamanager/integrations.md). Dazu navigieren Sie im Backend zu **CMS** → **Medien**. Wir bieten zwei Möglichkeiten an, Pixlr zu benutzen:
...
![Plugin Konfiguration von Pixlr](../../.gitbook/assets/module_pixlr_einstellungen.png)
