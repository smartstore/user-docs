...
4. Das Plugin sucht veröffentlichte Versandbedingungen für Versandmethode, Store, Lieferland, Postleitzahl und Warenkorbmenge.
...
3. Konfigurieren Sie die [Einstellungen](dimension-pricing/settings.md).
4. Legen Sie [Verpackungsarten und -größen](dimension-pricing/package-types-and-sizes.md) an.
...
Versandkostenfreie Artikel erzeugen kein eigenes Packstück; ihr Gewicht kann abhängig von den [Einstellungen](dimension-pricing/settings.md) dennoch die Auswahl und den Preis beeinflussen.
