...
| Captcha aktivieren                 | <p>Ein CAPTCHA ist ein automatisierter Test, der echte Nutzer von Bots unterscheidet, z. B. durch eine kurze Aufgabe oder eine unsichtbare Risikoprüfung. Es schützt Formulare und Logins vor Spam und Missbrauch.<br><br>Diese Option aktiviert den Spamschutz mittels <strong>Google reCAPTCHA</strong>. Smartstore unterstützt sowohl Version 2 als auch Version 3.<br><br>Um den Dienst zu nutzen, benötigen Sie ein Konto bei <a href="https://www.google.com/recaptcha/admin">Google reCAPTCHA</a>.<br><br>1. Erstellen Sie dort einen neuen Key.<br>2. Hinterlegen Sie den <strong>Websiteschlüssel (Public Key)</strong> und den <strong>Geheimen Schlüssel (Private Key)</strong> in den entsprechenden Feldern.<br>3. Wählen Sie die Theme-Einstellung passend zu Ihrem Key (V2 oder V3).</p> |
