...
Kundeneinstellungen nehmen Sie unter **Konfiguration > Einstellungen > Kunden-Einstellungen** vor.
...
![](../../../.gitbook/assets/kundeneinstellungen-registrierung.PNG)
...
![](../../../.gitbook/assets/kundeneinstellungen-datum-und-zeit.PNG)
...
|                                      |                                                                                                                                                                                                 |
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Automatische Registrierung aktiviert | Aktiviert die automatische Registrierung, falls externe Authentifikation verwendet wird. Mehr unter [Externe Authentifikation einrichten](../../kunden/externe-authentifikation-einrichten.md). |
