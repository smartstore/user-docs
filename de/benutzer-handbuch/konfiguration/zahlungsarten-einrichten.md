...
|                          |                                                                                                                                                                                                                                                                                                                |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Wiederkehrende Zahlungen | Wenn ein Zahlart-Plugin wiederkehrende Zahlungen unterstützt, kann es Zahlungsvorgänge für wiederkehrende Zahlungen automatisch abwickeln. Für weitere Informationen zu wiederkehrenden Zahlungen lesen Sie bitte [Mit Abonnements umgehen](../../abcd/katalog/produkte-verwalten/mit-abonnements-umgehen.md). |
