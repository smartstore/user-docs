...
Einige Shopfunktionen beziehen oder liefern Daten auf Grundlage Ihrer Ländereinstellungen. So können Sie zum Beispiel basierend auf dem Herkunftsland Ihres Kunden festlegen, ob die Preise in Ihrem Shop inklusive oder exklusive Mehrwertsteuer dargestellt werden. Sie können z.B. auch abhängig vom Land, das bei einer Bestellung in der Lieferadresse angegeben wird Einstellungen vornehmen, um Versandkosten zu berechnen. Um Länder in Ihrem Shop zu verwalten, gehen Sie **Konfiguration > Regionale Einstellungen > Länder**.
