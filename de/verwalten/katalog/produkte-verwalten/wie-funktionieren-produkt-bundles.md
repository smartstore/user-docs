...
2. Wählen Sie eines oder mehrere Produkte, indem Sie das Kästchen in der ersten Spalte aktivieren. Sie können die Suche verwenden, um Produkte schneller miteinander zu verbinden.
...
Es gibt drei wichtige Optionen, die das Verhalten eines Produkt-Bundles steuern. Sie finden diese oberhalb der Tabelle der Produkt-Bundles.
...
Die Preiskalkulation der Bundle-Bestandteile berücksichtigt Aktionspreise, Preisänderungen bei Attributen wie auch auf den Bundle-Bestandteil bezogene Rabatte und Mengen.\
...
| **Kurzbeschreibung**        | Bietet die Möglichkeit, in der Stückliste eine abweichende Kurzbeschreibung anzuzeigen. Geben Sie ein Leerzeichen ein, falls in der Stückliste keine Kurzbeschreibung angezeigt werden soll, obwohl das Produkt eine besitzt. |
...
| **Sichtbar**                | Ermöglicht es, ein im Bundle enthaltenes Produkt zu verbergen, sodass es auf der Produktseite nicht angezeigt wird.                                                                                                           |
