...
![](../../.gitbook/assets/edit-payment-method.png)
...
|                   |                                                                                                                                                                                                                                                                               |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Recurring Support | If a payment plugin supports recurring payments, it can handle automated payments for recurring products. For more information about recurring products, read the topic [Understanding Recurring Products](../catalog/managing-products/understanding-recurring-products.md). |
