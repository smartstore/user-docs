...
You can manage multiple stores in Smartstore by navigating to **Configuration > Stores**. For more information about working with multiple stores, read the topic [Working with Multiple Stores](../../discover/common-concepts/working-with-multiple-stores.md).

![](../../.gitbook/assets/multi-stores.png)
