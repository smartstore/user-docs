...
![](../../.gitbook/assets/language-chooser.png)
...
| <p>Round order total amount<br><br></p> | Specifies whether to round the order total amount (_cash rounding_). This setting is only effective if currency rounding is enabled for the payment method selected in the checkout.                                                                                                                                                                                              |
...
| Rounding rule                           | <p>The rule for rounding the order total amount. The following rules are available:<br><br>- Round midpoint down (e.g. 0.05 rounding: 9.225 will round to 9.20)<br>- Round midpoint up (e.g. 0.05 rounding: 9.225 will round to 9.25)<br>- Always round down (e.g. 0.05 rounding: 9.24 will round to 9.20)<br>- Always round up (e.g. 0.05 rounding, 9.26 will round to 9.30)</p> |
