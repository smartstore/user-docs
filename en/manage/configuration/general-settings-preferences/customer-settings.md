...
![](<../../../.gitbook/assets/customer settings3.jpg>)

|                              |                                                            |
| ---------------------------- | ---------------------------------------------------------- |
| 'Company' Enabled            | Specifies whether or not the company is enabled.           |
| 'Company' Required           | Specifies whether or not the company is required.          |
| 'Street Address' Enabled     | Specifies whether or not the street address is enabled.    |
| 'Street Address' Required    | Specifies whether or not the street address is required.   |
| 'Zip / Postal Code' Enabled  | Specifies whether or not the zip/portal code is enabled.   |
| 'Zip / Postal Code' Required | Specifies whether or not the zip/portal code is required.  |
| 'City' Enabled               | Specifies whether or not the city is enabled.              |
| 'City' Required              | Specifies whether or not the city is required.             |
| 'Country' Enabled            | Specifies whether or not the country is enabled.           |
| 'State/Province' Enabled     | Specifies whether or not the state or province is enabled. |
| 'Phone Number' Enabled       | Specifies whether or not the phone number is enabled.      |
| 'Phone Number' Required      | Specifies whether or not the phone number is required.     |
| 'Fax Number' Enabled         | Specifies whether or not the fax number is enabled.        |
| 'Fax Number' Required        | Specifies whether or not the fax number is required.       |
...
![](<../../../.gitbook/assets/customer settings4.jpg>)

|                                     |                                                                                                                                                                      |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Allow Customers To Select Time Zone | Check the box to allow customers to select the time zone. If checked, the time zone can be selected in the public store. If not, the default time zone will be used. |
| Default Store Time Zone             | Specifies the default store time zone.                                                                                                                               |

## External Authentication Settings

![](<../../../.gitbook/assets/customer settings5.jpg>)

|                       |                                                                                                                                                                                                                                                                                  |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Auto Register Enabled | Check the box to enable auto registration when using external authentication. With this option enabled, a new customer account will be created in your shop if a customer uses [External Authentication Methods](../../customers/setting-up-external-authentication-methods.md). |
