...
{% hint style="info" %}
**Global limit**: This limit is independent of the separate limits for guests and bots. Once this limit is reached, the system will block further requests, even if the other limits are not exceeded.
{% endhint %}
