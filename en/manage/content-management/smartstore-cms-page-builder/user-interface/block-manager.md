...
![](../../../../.gitbook/assets/doc.sm5.pb.story.block-manager.png)
...
![](../../../../.gitbook/assets/doc.sm5.pb.story.block-manager.settings.png)
...
\{% hint style="info" % } Note at this point that the _Smile_ block will no longer be displayed because its visibility has been turned off. However, the _Basics_ block will be displayed in any case, as it now overwrites the setting of the previous resolution.
