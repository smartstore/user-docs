...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.databinding.png)
...
![](../../../../.gitbook/assets/image-20230731-130953.png)
...
{% if RegularPrice %}
Special offer! Instead of \{{ RegularPrice \}} pay
{% endif %}
...
> \[!INFO] Note: Data Binding is only supported for text and image blocks.
