...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.picture.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.products-list.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.categories-list.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.brands-list.png)

### IFrame

With the IFrame block you can display an external page in a window. To do this, you must specify the URL of the page.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.IFrame-block.png)

### Gallery

The Gallery Block can be used to insert media galleries with different styles and effects as content in pages.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.Gallery-block.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.Video-block.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.youtube-block.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.soundcloud-block.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.google-maps-block.png)

### Blog

This block allows you to insert blog posts from the Smartstore blog plugin.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.blog-block.png)

### Trusted Shop

Trusted Shops ratings are displayed in this block. A Trusted Shops ID is required.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.trusted-shops-block.png)

### News

This block displays news from the Smartstore News plugin.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.news-block.png)

### Newsletter

This block represents the input field for the newsletter registration and thus enables a registration to the newsletter.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.newsletter-block.png)

### Poll

With this block, a poll can be selected and displayed from existing polls.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.poll.png)

### Content Slider

A slide can be selected and displayed from the existing Content Slider slides.

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.content-slider.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.code.png)

### View Component

This block supports the display of so-called View Components (see NET Core).

![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.viewcomponent.png)
...
![](../../../../.gitbook/assets/docs.sm5.pagebuilder.blocks.specific-settings.story.png)
