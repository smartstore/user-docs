...
![](../../.gitbook/assets/blog.post-detail.png)
...
In this tab you can enter specific SEO values for the blog post e.g. **Meta title**, **Meta keywords** or a SEO friendly **URL alias**. For more information about the fields in the **Seach engines** tab read the topic [SEO](../../discover/common-concepts/seo.md).

### Stores

In this tab, you can manage which store(s) the blog post should be published in. For more information about multiple stores, read the topic [Working with Multiple Stores](../../discover/common-concepts/working-with-multiple-stores.md).
