...
With field weighting, the order of search results can be influenced.
...
The search index can be re-indexed, updated, optimized, and edited using the button on the right.
...
Extensions for the MegaSearch Plugin. Supplements the product data of the search index with localized data and with multi-store and access restrictions.
