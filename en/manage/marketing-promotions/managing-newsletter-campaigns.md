...
![](../../.gitbook/assets/newsletter-box.png)
...
Create an [import profile](../data-exchange/managing-import-profiles.md) to import newsletter subscribers. Create an [export profile](../data-exchange/managing-export-profiles.md) if you want to export newsletter subscribers.
