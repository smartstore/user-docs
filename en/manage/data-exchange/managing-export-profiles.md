...
![](../../.gitbook/assets/export-profiles.png)
...
| -------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| **Offset**     | Defines the number of records to be skipped.                                                                                  |
...
| **Per store**  | Defines whether a separate processing run should take place for each store. A new file is generated for each store.           |
...
| **Pattern for file names** | <p>Specifies the pattern for creating file names. The <strong>Example</strong> button allows you to preview the result of the pattern resolving.<br><br><strong>Supported placeholders:</strong><br>- <strong>%Profile.Id%</strong>: The numeric identifier of the export profile.<br>- <strong>%Profile.FolderName%</strong>: The name of the export folder for the profile.<br>- <strong>%Profile.SeoName%</strong>: The SEO friendly name of the export profile.<br>- <strong>%ExportProfile.FolderName%</strong>: The name of the export folder for the profile.<br>- <strong>%Store.Id%</strong>: The numeric identifier of the store of the current export run-through.<br>- <strong>%Store.SeoName%</strong>: The SEO friendly name of the store of the current export run-through. Resolves to <code>allstores</code> if the <strong>Per store</strong> option is activated.<br>- <strong>%File.Index%</strong>: A one based file index.<br>- <strong>%Random.Number%</strong>: A random number.<br>- <strong>%Timestamp%</strong>: A UTC timestamp.<br><br><strong>Note:</strong> Placeholders are intended to easier create unique file names. Please pay attention to avoid patterrns that lead to non unique file names and thus file name conflicts.</p> |
...
| **Email notification**     | <p>Sends a notification email about the completion of an export. Note that you can specify multiple email addresses where to send the email to.<br><br><strong>Note:</strong> System exports (like product or category export) are always sending a notification email regardless of this option.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
![](../../.gitbook/assets/export-profile-preview.png)
