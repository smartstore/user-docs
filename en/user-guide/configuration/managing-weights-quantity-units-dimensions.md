# Managing Weights, Quantity Units & Dimensions
...
![](./attachments/weights.png)

## Managing Quantity Units

You can manage quantity units by going to **Configuration > Lists > Quantity Units**. The quantity units you enter here can be assigned to products in the [Product Info Tab](../../user-guide/catalog/managing-products/creating-and-editing-products.md). 

![](./attachments/quantity-units.png)
